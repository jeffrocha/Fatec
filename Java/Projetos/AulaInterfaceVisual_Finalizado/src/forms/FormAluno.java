...
public class FormAluno extends javax.swing.JFrame {
    ...
    if (txtPesquisar.getText().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Por favor, insira um ID para pesquisar.", "Erro", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "ID inválido. Por favor, insira um número correto.", "Erro", JOptionPane.ERROR_MESSAGE);
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, "Erro ao pesquisar aluno: " + e.getMessage(), "Erro", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
       if (txtId.getText().isEmpty()) {
        System.out.println("Nenhum aluno selecionado para edição!");
        return;
    }
